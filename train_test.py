...
print(test1.tail(10))
print(test1.shape)
test1.to_csv("data/test_sample1")
...
print(train1.shape)
train1.to_csv("data/train_sample1")
...
print(test2.tail(10))
print(test2.shape)
test2.to_csv("data/test_sample2")
...
print(train2.shape)
train2.to_csv("data/train_sample2")
...
print(test3.tail(10))
print(test3.shape)
test3.to_csv("data/test_sample3")
...
print(train3.shape)
train3.to_csv("data/train_sample3")
...
print(test4.tail(10))
print(test4.shape)
test4.to_csv("data/test_sample4")
...
print(train4.shape)
train4.to_csv("data/train_sample4")
...
print(test5.tail(10))
print(test5.shape)
test5.to_csv("data/test_sample5")
...
print(train5.shape)
train5.to_csv("data/train_sample5")